...
private CANdi shoulderAndTopCandi; 
  ...
  */
  private RobotContainer() {
    ...
    wristAndClawCandi = new CANdi(18, "rio");
    shoulderAndTopCandi = new CANdi(19, "rio");
    ...
    // Add CameraServer for the limeligt and standards camera
        ...
        UsbCamera httpCamera = CameraServer.startAutomaticCapture(0);
         Shuffleboard.getTab("REEFSCAPE").add(httpCamera);
